...
class Model(object):
    ...
    def from_result(result):
        return Model(result.model_configuration.optimiser(), result.model_configuration.layers().copy(), result.model_configuration.loss_function(), result.model_configuration.number_of_epochs(), result.final_weights())
