...
class BayesianMethod(hpo.Strategy):
    def __init__(self, model_configuration, number_of_iterations, surrogate_model, model_type=hpo.hpo_model.Model, remote_model_type=hpo.hpo_remote_model.RemoteModel):
